...
# Usage: bash scripts/submit-indexnow.sh https://www.wellnesstodays.com/blog/new-post-slug
...
if [ -z "$SITE_URL" ]; then
  ...
  echo "Example: bash scripts/submit-indexnow.sh https://www.wellnesstodays.com/blog/example-post"
  exit 1
fi
